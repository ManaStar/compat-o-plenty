...
public class CompatBlocks {
    ...
    public static final RegistryObject<Block> HELLBARK_BOOKSHELF = HELPER.createCompatBlock(CompatOPlenty.QUARK_ID, "hellbark_bookshelf", () -> new BookshelfBlock(CompatProperties.HELLBARK_BOOKSHELF), ItemGroup.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> HELLBARK_LADDER = HELPER.createCompatBlock(CompatOPlenty.QUARK_ID, "hellbark_ladder", () -> new AbnormalsLadderBlock(CompatProperties.HELLBARK_LADDER), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> STRIPPED_HELLBARK_POST = HELPER.createCompatBlock(CompatOPlenty.QUARK_ID, "stripped_hellbark_post", () -> new WoodPostBlock(AbstractBlock.Properties.copy(BOPBlocks.hellbark_planks)), ItemGroup.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> HELLBARK_POST = HELPER.createCompatBlock(CompatOPlenty.QUARK_ID, "hellbark_post", () -> new WoodPostBlock(STRIPPED_HELLBARK_POST,  AbstractBlock.Properties.copy(BOPBlocks.hellbark_planks)), ItemGroup.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> HELLBARK_HEDGE = HELPER.createCompatBlock(CompatOPlenty.QUARK_ID, "hellbark_hedge", () -> new HedgeBlock(AbstractBlock.Properties.copy(BOPBlocks.hellbark_planks)), ItemGroup.TAB_DECORATIONS);
